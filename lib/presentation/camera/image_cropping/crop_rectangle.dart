...
class _CroppingRectangleState extends State<CroppingRectangle> {
  ...
  void initState() {
    ...
    dev.log(
        "imgRenderWidth: $imgRenderWidth, imgRenderHeight: $imgRenderHeight");
    ...
    pivotPositions = [
      Offset(left + detectedEdges.topLeft.dx * imgRenderWidth,
      ...
      Offset(left + detectedEdges.bottomRight.dx * imgRenderWidth,
          top + detectedEdges.bottomRight.dy * imgRenderHeight),
      Offset(left + detectedEdges.bottomLeft.dx * imgRenderWidth,
              ...
              child: CroppingPivot(
                ...
                onDragCallback: (position) {
                  setState(() {
                    ...
                    detectedEdges.topLeft =
                        _clampPos(detectedEdges.topLeft + newPos);
                  });
                },
              ),
            ),
            Positioned(
              ...
              child: CroppingPivot(
                ...
                onDragCallback: (position) {
                  setState(() {
                    Offset newPos = _applyPositionScaling(position);
                    detectedEdges.topRight =
                        _clampPos(detectedEdges.topRight + newPos);
                  });
                },
              ),
            ),
            Positioned(
              ...
              child: CroppingPivot(
                ...
                onDragCallback: (position) {
                  setState(() {
                    Offset newPos = _applyPositionScaling(position);
                    detectedEdges.bottomRight =
                        _clampPos(detectedEdges.bottomRight + newPos);
                  });
                },
              ),
            ),
            Positioned(
              ...
              child: CroppingPivot(
                ...
                onDragCallback: (position) {
                  setState(() {
                    Offset newPos = _applyPositionScaling(position);
                    detectedEdges.bottomLeft =
                        _clampPos(detectedEdges.bottomLeft + newPos);
                  });
                },
              ),
            ),
  ...
  Offset _applyPositionScaling(Offset pos) {
    return Offset(pos.dx / imgRenderWidth, pos.dy / imgRenderHeight);
  }
  ...
  Offset _clampPos(Offset pos) {
    ...
    return Offset(x.clamp(0.0, imgRenderWidth) / imgRenderWidth,
